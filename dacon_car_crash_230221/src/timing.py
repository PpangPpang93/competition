...
if __name__ == '__main__':
    ...
    if (args.mode == 'train'):
        ...
        df = pd.read_csv('/data/home/ubuntu/workspace/dacon/data/train_timing.csv')
        ...
        # wandb
        wandb.login()
        wandb.init(project='timing_resnet101', config=CFG)
        # wandb.config
        ...
        test['timing'] = preds
        test.to_csv('/data/home/ubuntu/workspace/dacon/data/test_timing.csv', index=False)