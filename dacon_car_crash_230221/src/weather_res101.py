...
def train(model, optimizer, train_loader, val_loader, scheduler, device):
    ...
    for epoch in range(1, CFG['EPOCHS']+1):
        ...
        torch.save(model.state_dict(), '/data/home/ubuntu/workspace/dacon/ckp/weather_res101_{0:02d}.ckpt'.format(epoch))
...
if __name__ == '__main__':
    ...
    if (args.mode == 'train'):
        ...
        df = pd.read_csv('/data/home/ubuntu/workspace/dacon/data/train_weather.csv')
        ...
        # wandb
        wandb.login()
        wandb.init(project='weather_resnet101', config=CFG)
        # wandb.config
        ...
        test['weather'] = preds
        test.to_csv('/data/home/ubuntu/workspace/dacon/data/test_weather.csv', index=False)